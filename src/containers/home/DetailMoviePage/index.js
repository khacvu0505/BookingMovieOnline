...
import $ from "jquery";
import { actFetchInfoDetailMovie, actFetchListLogoShowTime } from '../../../components/ShowTimes/module/action';
...
function DetailMovie(props) {
  ...
  const renderFilmDetail = () => {
    if (props.infoDetailMovie.lichChieu && props.infoDetailMovie.lichChieu.length > 0) {
  ...
  return (
    ...
    <div>
      <section className="detailMovie">
        <div className="detailMovie__banner">
        </div>
        ...
        <div className="container detailMovie__info">
          <div className="row">
            <div className="col-6 col-md-3 detail__img">
              <LazyLoadImage src={props.infoDetailMovie.hinhAnh} alt="CucNoHoaCucCung" className="img-fluid w-100" />
              <div className="icon__play">
                <a className="video" href={props.infoDetailMovie.trailer} data-lity>
                  <i className="fa fa-play"></i>
                </a>
              </div>
            </div>
            <div className="col-md-5 infoText my-auto">
              <p className="date">{new Date(props.infoDetailMovie.ngayKhoiChieu).toLocaleDateString()}</p>
              <p><span>P</span>{props.infoDetailMovie.tenPhim}</p>
              <span>120 phút - 0 IMDb - 2D/Digital</span><br />
              <button className="button__muaVe">Mua Vé</button>
            </div>
            <div className="col-md-4">
              <div className="progress-pie-chart" data-percent={props.infoDetailMovie.danhGia}>
      ...
      <section className="detailMovie_ShowTimes">
        <div className="container">
          ...
          <div className="tab-content detailShowtime__content" id="myTabContent">
            <div className="tab-pane fade show active  mt-5" id="showtime" role="tabpanel" aria-labelledby="showtime-tab">
              ...
              <section className="lichChieu container-md ">
                <div className="row lichChieu__content mb-5" style={{ backgroundColor: "white" }}>
                  ...
                  <div className="col-lg-11 p-0">
                    ...
                    <div className="tab-content lichChieu__Phim" id="v-pills-tabContent">
                      {renderFilmDetail()}
                    </div>
                  </div>
                </div>
            ...
            <div className="tab-pane fade mt-5 content__Infomation" id="infomation" role="tabpanel" aria-labelledby="infomation-tab">
              <div className="row">
                <div className="col-md-6 text-center">
                  <p>Tên Phim : <span className="ml-5">{props.infoDetailMovie.tenPhim}</span></p>
                  <p>Bí Danh : <span className="ml-5">{props.infoDetailMovie.biDanh}</span></p>
                  <p>Ngày Khời Chiếu : <span className="ml-5">{new Date(props.infoDetailMovie.ngayKhoiChieu).toLocaleDateString()}</span></p>
                ...
                <div className="modal-dialog modal-dialog-centered">
                  <div className="modal-content">
                    ...
                    <div className=" modal-body m-1 h-100">
                      ...
                      <textarea placeholder="Nói cho mọi người biết bạn nghĩ gì về phim này..." className="w-100  text-dark" value={comment} onChange={handleChangeComment} style={{ height: "100px" }} />
                    </div>
                    <div className=" modal-footer">
                      <button type="button" className="btn btn-danger" onClick={handleSubmitRating} data-dismiss="modal">Đăng</button>
                    </div>
                  </div>
                </div>
              </div>
