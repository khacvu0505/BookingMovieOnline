...
import { actFetchListMovieDangChieu, actFetchListMovieSapChieu } from "./module/action";
      ...
      <section className="listMovie container">
        <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
          <li className="nav-item" role="presentation">
            <a className="nav-link active button" id="pills-dangChieu-tab" data-toggle="pill" href="#pills-dangChieu" role="tab" aria-controls="pills-dangChieu" aria-selected="true">Phim
                đang chiếu</a>
          </li>
          <li className="nav-item" role="presentation">
            <a className="nav-link button" id="pills-sapChieu-tab" data-toggle="pill" href="#pills-sapChieu" role="tab" aria-controls="pills-sapChieu" aria-selected="false">Phim sắp chiếu</a>
          </li>
        </ul>
        <div className="tab-content listMovie__content" id="pills-tabContent">
          <div className="tab-pane fade show active content__item" id="pills-dangChieu" role="tabpanel" aria-labelledby="pills-dangChieu-tab">
          ...
          <div className="tab-pane fade content__item" id="pills-sapChieu" role="tabpanel" aria-labelledby="pills-sapChieu-tab">
            <div className="content__dangChieu">
              <Slider {...listMovie}>
